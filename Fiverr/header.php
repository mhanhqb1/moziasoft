<div id="main-wrapper-header">
    ...
    <header class="base-header logged-out-homepage-header js-main-header header-search transparent-header"><!--transparent-header-->
        <div class="header-row">
            <a id="mobilemenuicon" href="#!" class=" navicon js-side-nav-trigger js-header-events">
            ...
            <nav class="header-nav guest-nav">
                <ul>
                    <li class="header-start-selling">
                        <a class=" js-header-events" href="/" rel="nofollow">
                            Sign Up
                        </a>
                    </li>
                    <li class="header-login">
                        <a href="/" class="js-open-popup-login js-header-events">
                            Login
                        </a>
                    </li>
                    <li class="header-join">
                        <a href="/" class="js-open-popup-join js-header-events">
                            Join
                        </a>
                    </li>
                </ul>
